...
const Collection = ({ onAddToCart, onImageClick, onBulkEnquire }) => {
  ...
  const products = {
    honey: [
      {
        id: 'regular',
        title: 'Regular Raw Honey',
        basePrice: 150.0,
        tag: 'BESTSELLER',
        desc: 'Sourced from Sunflower, Wildflower, Blue Gum, or Eucalyptus. A pure, liquid amber experience.',
      ...
      },
      {
        ...
        basePrice: 160.0,
        tag: 'ARTISANAL',
        desc: 'Controlled crystallization creates a luxurious, spreadable texture. Perfect for toast.',
        image: '/images/7.jpeg',
        intensity: 2,
        isVariable: true,
        variantType: 'honey',
      },
      {
        ...
        basePrice: 180.0,
        tag: 'WELLNESS',
        desc: 'Choose from Lemon, Garlic, or Ginger infusions. A powerful boost for your immune system.',
    ...
    accessories: [
      {
        id: 'bamboo-dipper',
        title: 'Engraved Bamboo Dipper',
        basePrice: 45.0,
        tag: 'ACCESSORY',
        desc: 'Sustainable bamboo honey dipper engraved with the Golden Grace insignia.',
        image: '/images/WhatsApp Image 2025-12-22 at 21.14.15.jpeg',
        isVariable: true,
        variantType: 'size',
      },
      {
        id: 'bamboo-ladle',
        title: 'Engraved Bamboo Ladle',
        basePrice: 55.0,
        tag: 'PREMIUM',
        desc: 'Our signature dark honeycomb ladle. Hand-carved for the perfect pour.',
        image: '/images/WhatsApp Image 2025-12-22 at 21.14.16.jpeg',
        isVariable: true,
        variantType: 'size',
      },
      {
        id: 'perspex-dipper',
        title: 'Perspex Dipper',
        basePrice: 65.0,
        tag: 'MODERN',
        desc: 'Sleek, easy-to-clean perspex dipper for a modern aesthetic.',
    ...
    kitchen: [
      {
        id: 'coaster',
        title: 'Honeycomb Coaster',
        basePrice: 30.0,
        tag: 'HOME',
        desc: 'Protect your table with our stylish honeycomb-patterned coasters.',
      ...
      {
        id: 'mug',
        title: 'Sublimation Mug',
        basePrice: 95.0,
        tag: 'MERCH',
        desc: 'Premium mug with black interior and white exterior, branded with our logo.',
        image: '/images/WhatsApp Image 2025-12-22 at 21.14.20.jpeg',
        isVariable: false,
      },
    ],
  };
    ...
    <section id="collection" className="py-16 md:py-32 bg-[#0a0a0a]">
      <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-12">
        <div className="text-center mb-10 md:mb-16">
          <span className="text-amber-500 tracking-[0.5em] text-xs 2xl:text-sm font-bold uppercase">
            The Golden Collection
          </span>
          <h2 className="text-4xl md:text-7xl 2xl:text-9xl font-serif text-white mt-4 md:mt-6 mb-8">
        ...
        <div className="mt-16 text-center bg-[#121212] p-8 rounded-lg border border-amber-500/20 max-w-3xl mx-auto">
          ...
          <p className="text-gray-400 mb-6 text-sm md:text-base">
            We cater for bulk sales. Get cases of 24, 5L buckets, or 20L drums for your business or
            event.
          </p>
          <button
