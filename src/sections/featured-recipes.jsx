...
const FeaturedRecipes = ({ navigate }) => (
  <section className="py-16 bg-[#121212] border-t border-white/5">
        <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-12 text-center">
            ...
            <button onClick={() => navigate('recipes')} className="border border-white/20 text-white px-8 py-3 uppercase tracking-widest text-xs font-bold hover:bg-white hover:text-black transition-colors">View Recipes</button>
        </div>
    </section>
);
