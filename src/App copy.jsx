...
import { ShoppingBag, Menu, X, ArrowRight, Star, Droplet, Hexagon, CheckCircle, ShieldCheck, Award, Heart, Gift, GraduationCap, MapPin, Phone, Mail, Instagram, Twitter, Facebook, MessageCircle, Minus, Plus, Trash2, ExternalLink, ChevronDown, Play, Users, Sun, Maximize2, ArrowLeft } from 'lucide-react';

/* GOLDEN GRACE HONEY - PHASE 12: FINAL FIX & POLISH
   Updated: 2025-12-13
   Features: Mobile-First Architecture + Ultra-Wide (18"+ Monitor) Optimization
   Fixes: Corrected Component definition order, ReferenceErrors, Object rendering
*/
          ...
          <div className="hidden lg:flex items-center gap-8 xl:gap-12">
            {navLinks.map((item) => (
              <button 
                ...
                className={`text-xs xl:text-sm tracking-[0.15em] uppercase transition-colors relative group font-medium ${activePage === item.id ? 'text-amber-400' : 'text-white/80 hover:text-amber-400'}`}
              >
                {item.label}
  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-[100dvh] w-full overflow-hidden flex items-center justify-center pt-20 md:pt-0">
      <div className="absolute inset-0 z-0">
        ...
        >
            {/* Using a high quality Pexels video link for stability */}
      ...
      <div className="relative z-20 text-center px-4 md:px-6 max-w-screen-xl 2xl:max-w-screen-2xl w-full">
        <div className="inline-flex items-center gap-2 border border-amber-500/30 bg-black/40 backdrop-blur-md px-3 py-1.5 md:px-4 md:py-2 rounded-full mb-6 md:mb-8 animate-fade-in-up">
            <CheckCircle className="text-amber-400 w-3 h-3 md:w-4 md:h-4" />
            <span className="text-amber-400 text-[10px] md:text-xs tracking-widest uppercase font-bold">100% Raw & Authentic</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto animate-fade-in-up delay-500 px-4 md:px-0">
            <div className="bg-black/30 backdrop-blur-md border border-white/10 p-4 rounded-lg flex items-center gap-4 hover:bg-white/5 transition-colors cursor-pointer group">
                <div className="bg-amber-500/20 p-3 rounded-full group-hover:bg-amber-500 transition-colors">
                    <Users className="text-amber-400 group-hover:text-black w-5 h-5 md:w-6 md:h-6" />
                </div>
                <div className="text-left">
                    <h4 className="text-white font-serif text-lg 2xl:text-xl">Women-Led Impact</h4>
                    <p className="text-gray-400 text-xs 2xl:text-sm">Empowering local communities through every jar sold.</p>
                </div>
            </div>
            <div className="bg-black/30 backdrop-blur-md border border-white/10 p-4 rounded-lg flex items-center gap-4 hover:bg-white/5 transition-colors cursor-pointer group">
                <div className="bg-amber-500/20 p-3 rounded-full group-hover:bg-amber-500 transition-colors">
                    <Sun className="text-amber-400 group-hover:text-black w-5 h-5 md:w-6 md:h-6" />
                </div>
                <div className="text-left">
                    <h4 className="text-white font-serif text-lg 2xl:text-xl">Nature's Pharmacy</h4>
                    <p className="text-gray-400 text-xs 2xl:text-sm">Rich in antioxidants, enzymes, and natural healing.</p>
                </div>
            </div>
        </div>
      </div>
...
const TrustBar = () => {
    return (
        <div className="bg-[#0a0a0a] border-y border-white/5 py-6 md:py-8 relative overflow-hidden">
...
const ContentBreak = () => (
    <div className="bg-[#121212] py-16 border-t border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h3 className="text-amber-500 tracking-widest text-xs font-bold uppercase mb-4">Did You Know?</h3>
            <p className="text-xl md:text-3xl font-serif text-white leading-relaxed">
...
const SensorySection = () => {
    return (
        <section id="sensory" className="py-16 md:py-20 bg-[#080808] relative">
...
const Collection = ({ onAddToCart, onImageClick, onBulkEnquire }) => {
  const products = [
    ...
    { id: 'mini', title: "Mini Gift Jar", basePrice: 85.00, tag: "GIFTING", desc: "A precious mini jar in a special bag with a wooden dipper and bee charm.", image: "https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?q=80&w=2070&auto=format&fit=crop", intensity: 3, isVariable: false },
    ...
    <section id="collection" className="py-16 md:py-32 bg-[#0a0a0a]">
      <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-12">
        <div className="text-center mb-10 md:mb-20">
          ...
          <h2 className="text-4xl md:text-7xl 2xl:text-9xl font-serif text-white mt-4 md:mt-6 mb-4">Taste of South Africa</h2>
        ...
        <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-12">
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8">
                    <p className="text-gray-300 max-w-lg">From corporate hampers to wedding favors, discover our range of bespoke honey gifts.</p>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 2xl:gap-20">
                    ...
                    <div className="w-full md:w-2/3 text-center md:text-left">
                        ...
                        <p className="text-gray-400 text-base md:text-lg 2xl:text-2xl leading-relaxed italic mb-8">
                            "Grace in Every Drop is not just a slogan; it is our promise. We operate with absolute transparency and integrity, fostering enduring trust with our community and our bees."
                        </p>
...
// Updated HomePage with "Featured" sections to introduce inner pages
