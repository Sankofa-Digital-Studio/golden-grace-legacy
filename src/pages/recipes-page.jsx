            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
                ...
                <div className="bg-[#121212] rounded-xl overflow-hidden group hover:border-amber-500/50 border border-transparent transition-all">
                    <div className="h-48 md:h-56 lg:h-80 overflow-hidden">
                        {/* Using the food/gift context shot */}
                        <img 
                            src="/images/recipe-hero.webp" 
                ...
                <div className="bg-[#121212] rounded-xl overflow-hidden group hover:border-amber-500/50 border border-transparent transition-all">
                    <div className="h-48 md:h-56 lg:h-80 overflow-hidden">
                        {/* Reusing creamed honey product shot as it's relevant to texture */}
                        <img 
                            src="/images/prod-creamed.webp" 
                            className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 golden-filter" 
                            alt="Honey Mask" 
                            loading="lazy"
                        />
                ...
                {/* Recipe 3: Immunity Elixir */}
                <div className="bg-[#121212] rounded-xl overflow-hidden group hover:border-amber-500/50 border border-transparent transition-all">
                    <div className="h-48 md:h-56 lg:h-80 overflow-hidden">
                        {/* Reusing infused honey product shot */}
                        <img 
                            src="/images/prod-infused.webp" 
                            className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 golden-filter" 
                            alt="Honey Tea" 
                            loading="lazy"
                        />
