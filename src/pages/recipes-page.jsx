        ...
        <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
                <div className="bg-[#121212] rounded-xl overflow-hidden group hover:border-amber-500/50 border border-transparent transition-all">
                    <div className="h-48 md:h-56 lg:h-80 overflow-hidden"><img src="/images/16.webp" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 golden-filter" alt="Honey Toast" loading="lazy" /></div>
                    <div className="p-6 lg:p-8">
                        ...
                        <button onClick={() => onReadRecipe('Golden Ricotta Toast')} className="flex items-center gap-2 text-white text-xs lg:text-sm uppercase tracking-widest hover:text-amber-400 transition-colors">Read Recipe <ArrowRight size={14} /></button>
                    </div>
                </div>
                {/* Additional recipes here using /images/7.webp and /images/17.webp */}
                <div className="bg-[#121212] rounded-xl overflow-hidden group hover:border-amber-500/50 border border-transparent transition-all">
                    <div className="h-48 md:h-56 lg:h-80 overflow-hidden"><img src="/images/7.webp" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 golden-filter" alt="Honey Mask" loading="lazy" /></div>
                    <div className="p-6 lg:p-8">
                        ...
                        <button onClick={() => onReadRecipe('Raw Honey Face Mask')} className="flex items-center gap-2 text-white text-xs lg:text-sm uppercase tracking-widest hover:text-amber-400 transition-colors">Read Routine <ArrowRight size={14} /></button>
                    </div>
                </div>
                <div className="bg-[#121212] rounded-xl overflow-hidden group hover:border-amber-500/50 border border-transparent transition-all">
                    <div className="h-48 md:h-56 lg:h-80 overflow-hidden"><img src="/images/17.webp" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 golden-filter" alt="Honey Tea" loading="lazy" /></div>
                    <div className="p-6 lg:p-8">
                        ...
                        <button onClick={() => onReadRecipe('Immunity Elixir')} className="flex items-center gap-2 text-white text-xs lg:text-sm uppercase tracking-widest hover:text-amber-400 transition-colors">Read Recipe <ArrowRight size={14} /></button>
                    </div>
                </div>
            </div>
        </div>
