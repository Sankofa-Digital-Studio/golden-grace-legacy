        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="space-y-2 mb-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h4 className="text-white font-serif text-2xl group-hover:text-amber-400 transition-colors">
                      {product.title}
                    </h4>
                  </div>
              ...
              <button
                onClick={() => onAddToCart(product, selectedSizes[product.id] || product.sizes[0])}
