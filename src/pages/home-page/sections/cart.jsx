...
export const Cart = ({ isOpen, onClose, cartItems = [], onUpdateQuantity, onRemove, onNavigate }) => {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-8 no-scrollbar">
            {cartItems.length === 0 ? (
              ...
              cartItems.map((item) => (
                <div key={`${item.id}-${item.selectedSize}`} className="flex gap-6 group animate-in fade-in slide-in-from-right-4 duration-500">
                  {/* Thumbnail */}
            ...
            <div className="p-8 bg-[#050505] border-t border-white/5 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[8px] text-gray-600 text-center uppercase font-black tracking-[0.3em] flex items-center justify-center gap-2">
                   ...
                   A harvest provided by Him. Bottled for you.
                </p>
              </div>
            </div>
          )}
