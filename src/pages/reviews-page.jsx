  ...
  const reviews = [
    {
      ...
      role: 'Verified Buyer',
      rating: 5,
      text: 'The Blue Gum variety is now a staple in my tea. Absolutely delicious and you can taste the purity.',
      date: '2 days ago',
    },
    {
      id: 2,
      ...
      rating: 5,
      text: 'I use Golden Grace in my glaze for duck. The consistency is unmatched by commercial brands.',
      date: '1 week ago',
    },
    {
      id: 3,
      ...
      role: 'Wellness Coach',
      rating: 5,
      text: "I recommend the raw honeycomb to all my clients for skincare. It's liquid gold.",
      date: '2 weeks ago',
    },
    {
      id: 4,
      ...
      role: 'Verified Buyer',
      rating: 4,
      text: 'Great taste, but I wish the delivery was faster to Cape Town. Worth the wait though!',
      date: '3 weeks ago',
    },
    {
      id: 5,
      ...
      role: 'Verified Buyer',
      rating: 5,
      text: 'The infused ginger honey saved me this winter. A daily spoonful kept the flu away.',
      date: '1 month ago',
    },
    {
      id: 6,
      name: 'Thabo N.',
      role: 'Beekeeping Student',
      rating: 5,
      text: 'Attended their workshop in Welkom. Grace is an inspiring teacher and mentor.',
      date: '1 month ago',
    },
  ];
    ...
    <div className="pt-32 pb-20 bg-[#050505] min-h-screen px-4 md:px-8 lg:px-12">
      ...
      <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6 max-w-7xl mx-auto">
        {reviews.map((review, i) => (
          <div
            key={review.id}
            className="break-inside-avoid bg-zinc-900/40 backdrop-blur-md border border-white/5 p-8 rounded-xl hover:border-amber-500/30 hover:bg-zinc-900/60 transition-all duration-500 group relative overflow-hidden shadow-lg"
            ...
            <div className="flex text-amber-400 mb-4 gap-1 relative z-10">
              {[...Array(5)].map((_, starI) => (
                <Star
                  ...
                  className={starI >= review.rating ? 'text-gray-700' : ''}
                />
              ))}
            </div>

            <p className="text-gray-200 text-sm leading-relaxed mb-6 font-light italic relative z-10">
              "{review.text}"
            </p>
