...
const EducationPage = ({ onScheduleClick }) => {
  useSEO("Bee Smart - Education", "Learn about the African Honey Bee and sustainable beekeeping in the Free State.");
  useAnalytics("Education Page");

  const seasons = [
    { season: "Spring (Aug-Oct)", activity: "Swarming Season", desc: "Colonies expand rapidly with the blooming of Aloes and fruit trees." },
    { season: "Summer (Nov-Feb)", activity: "Honey Flow", desc: "Peak nectar collection from Sunflowers and Cosmos. The main harvest begins." },
    { season: "Autumn (Mar-May)", activity: "Preparation", desc: "Bees store reserves for winter. We ensure hives are insulated and safe." },
    { season: "Winter (Jun-Jul)", activity: "Dormancy", desc: "The colony clusters for warmth. Minimal activity to conserve energy." }
  ];
    ...
    <div className="pt-32 pb-20 bg-[#050505] min-h-screen">
      <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
            <span className="text-amber-500 tracking-[0.3em] text-xs lg:text-sm font-bold uppercase">Academy</span>
            <h1 className="text-4xl md:text-6xl font-serif text-white mt-4 mb-6">Guardians of the Hive</h1>
            <p className="text-gray-400 max-w-3xl mx-auto text-sm md:text-lg">Discover the fascinating world of the African Honey Bee (Apis mellifera scutellata) and our commitment to sustainable practices in the Free State.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            <div className="space-y-6">
                ...
                <p className="text-gray-400 leading-relaxed">Native to central and southern Africa, our bees are known for their high energy and vigorous defense of the hive. Unlike their European counterparts, they are better adapted to our harsh climate, resisting pests like the Varroa mite naturally without chemical intervention.</p>
        ...
        <div className="mb-24">
            <h3 className="text-3xl font-serif text-white text-center mb-10">The Beekeeper's Calendar</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {seasons.map((s, i) => (
                    <div key={i} className="bg-[#121212] border border-white/5 p-6 rounded-lg hover:border-amber-500/50 transition-all group cursor-default">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-amber-500 text-xs font-bold uppercase tracking-wider">{s.season}</span>
                            <Calendar size={16} className="text-gray-600 group-hover:text-amber-500 transition-colors" />
                        </div>
