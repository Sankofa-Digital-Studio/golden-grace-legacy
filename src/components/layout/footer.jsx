          ...
          <div className="w-full">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
             ...
             <div className="mt-8 pt-4 border-t border-white/10">
                <button onClick={() => onOpenModal('sustainability')} className="flex items-center gap-2 text-xs text-green-500 hover:text-green-400 transition-colors uppercase tracking-widest">
