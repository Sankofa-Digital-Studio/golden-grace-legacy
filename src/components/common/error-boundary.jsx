  ...
  render() {
    if (this.state.hasError) return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#050505] text-white p-4 text-center">
            ...
            <button title='Refresh_Page' onClick={() => window.location.reload()} className="px-6 py-2 bg-amber-500 text-black font-bold uppercase tracking-widest hover:bg-white transition-colors">Refresh Page</button>
        </div>
    );
